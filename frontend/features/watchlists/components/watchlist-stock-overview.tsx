        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <div>
                <div className="text-3xl leading-tight font-bold text-gray-900 dark:text-white">
...
function RangeCard({ title, lowLabel, highLabel, progress }: RangeCardProps) {
  ...
  return (
    <div className="bg-white p-3 dark:bg-gray-900">
      <div className="mb-3 text-xs font-medium text-gray-900 dark:text-white">
        {title}
      </div>
...
function MetricGroup({ title, metrics }: MetricGroupProps) {
  ...
  return (
    <div className="rounded-2xl border border-gray-100 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
      ...
      <div className="grid grid-cols-2 divide-y divide-gray-100 text-sm md:grid-cols-4 md:divide-x md:divide-y-0 dark:divide-gray-800">
